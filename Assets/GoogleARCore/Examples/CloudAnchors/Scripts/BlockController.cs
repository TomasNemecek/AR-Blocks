...
namespace GoogleARCore.Examples.CloudAnchors
{
    ...
    public class BlockController : MonoBehaviour
    {
        ...
        /// </summary>
        private GameObject m_BlockMesh;
        ...
        public void Awake()
        {
            ...
            m_BlockMesh = transform.Find("BlockMesh").gameObject;
            m_BlockMesh.SetActive(false);
        }
